...
const pathToRoute = (pathname: string): PageRoute => {
  ...
  if (clean.startsWith("work/") || clean.startsWith("case-study") || clean === "case-study-web") return "case-study-web"
  if (clean === "services") return "services"
  if (clean.startsWith("services/web") || clean === "services-web" || clean.includes("web-dev")) return "services-web"
  if (clean.startsWith("services/mobile") || clean === "services-mobile" || clean.includes("mobile-app")) return "services-mobile"
  if (clean.startsWith("services/auto") || clean === "services-automation" || clean.includes("ai-auto")) return "services-automation"
