        ...
        <div className="container max-w-6xl mx-auto px-4 sm:px-6">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6 text-center md:text-left">
            <div className="border-l-2 border-purple-500 pl-3 sm:pl-4">
              <div className="text-xl sm:text-3xl font-bold font-mono text-white">60 FPS</div>
              <div className="text-[11px] sm:text-xs text-zinc-400 mt-1">Silky Smooth UI Motion</div>
            </div>
            <div className="border-l-2 border-[#FF4D3D] pl-3 sm:pl-4">
              <div className="text-xl sm:text-3xl font-bold font-mono text-white">iOS &amp; Android</div>
              <div className="text-[11px] sm:text-xs text-zinc-400 mt-1">Single Codebase Efficiency</div>
            </div>
            <div className="border-l-2 border-purple-500 pl-3 sm:pl-4">
              <div className="text-xl sm:text-3xl font-bold font-mono text-white">Offline Sync</div>
              <div className="text-[11px] sm:text-xs text-zinc-400 mt-1">Local SQLite &amp; Cloud Relays</div>
            </div>
            <div className="border-l-2 border-[#FF4D3D] pl-3 sm:pl-4">
              <div className="text-xl sm:text-3xl font-bold font-mono text-white">App Stores</div>
              <div className="text-[11px] sm:text-xs text-zinc-400 mt-1">End-to-End Submission Support</div>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container max-w-6xl mx-auto px-4 sm:px-6 space-y-8 sm:space-y-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6">
            <div className="p-4.5 sm:p-6 rounded-2xl bg-zinc-950/80 border border-zinc-800/90 hover:border-sky-500/60 hover:shadow-[0_0_20px_rgba(14,165,233,0.2)] transition-all space-y-3 sm:space-y-4">
              ...
              <h3 className="text-lg sm:text-xl font-bold text-white">Cross-Platform Unified Core</h3>
            ...
            <div className="p-4.5 sm:p-6 rounded-2xl bg-zinc-950/80 border border-zinc-800/90 hover:border-purple-500/60 hover:shadow-purple-glow transition-all space-y-3 sm:space-y-4">
              ...
              <h3 className="text-lg sm:text-xl font-bold text-white">Push Notifications &amp; Engagement</h3>
              <p className="text-xs sm:text-sm text-zinc-400 leading-relaxed">
            ...
            <div className="p-4.5 sm:p-6 rounded-2xl bg-zinc-950/80 border border-zinc-800/90 hover:border-[#FF4D3D]/60 hover:shadow-[0_0_20px_rgba(255,77,61,0.2)] transition-all space-y-3 sm:space-y-4">
              ...
              <h3 className="text-lg sm:text-xl font-bold text-white">App Store Approval Guarantee</h3>
              <p className="text-xs sm:text-sm text-zinc-400 leading-relaxed">
