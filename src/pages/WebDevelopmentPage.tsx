...
export const WebDevelopmentPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#070708] text-white selection:bg-purple-600 selection:text-white">
      ...
      {/* Metrics Banner */}
      <section className="py-6 sm:py-12 border-b border-zinc-800 bg-[#070708] text-white">
        <div className="container max-w-6xl mx-auto px-4 sm:px-6">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-8 text-center">
            <div className="space-y-1">
              <div className="text-xl sm:text-3xl font-bold font-mono text-white">&lt;0.4s</div>
              <div className="text-[10px] sm:text-xs text-zinc-400 uppercase tracking-wider font-mono">Load Speed</div>
            </div>
            <div className="space-y-1">
              <div className="text-xl sm:text-3xl font-bold font-mono text-white">100/100</div>
              <div className="text-[10px] sm:text-xs text-zinc-400 uppercase tracking-wider font-mono">Lighthouse Score</div>
            </div>
            <div className="space-y-1">
              <div className="text-xl sm:text-3xl font-bold font-mono text-white">2 - 3 Weeks</div>
              <div className="text-[10px] sm:text-xs text-zinc-400 uppercase tracking-wider font-mono">Sprint Turnaround</div>
            </div>
            <div className="space-y-1">
              <div className="text-xl sm:text-3xl font-bold font-mono text-white">100%</div>
              <div className="text-[10px] sm:text-xs text-zinc-400 uppercase tracking-wider font-mono">Code Handover</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 sm:py-20 bg-[#070708] text-white relative overflow-hidden">
        <div className="container max-w-6xl mx-auto px-4 sm:px-6 space-y-8 sm:space-y-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6">
            <div className="p-4.5 sm:p-6 rounded-2xl bg-zinc-950/80 border border-zinc-800/90 hover:border-sky-500/60 hover:shadow-[0_0_25px_rgba(14,165,233,0.25)] transition-all space-y-3 sm:space-y-4">
              <div className="h-9 w-9 sm:h-10 sm:w-10 rounded-xl bg-sky-500/10 text-sky-400 flex items-center justify-center font-bold">
                <Gauge className="h-4.5 w-4.5 sm:h-5 sm:w-5" />
              </div>
              <h3 className="text-lg sm:text-xl font-bold text-white">Sub-Second Performance</h3>
            ...
            <div className="p-4.5 sm:p-6 rounded-2xl bg-zinc-950/80 border border-zinc-800/90 hover:border-purple-500/60 transition-all space-y-3 sm:space-y-4">
              ...
              <h3 className="text-lg sm:text-xl font-bold text-white">Fluid Animations &amp; Taste</h3>
              <p className="text-xs sm:text-sm text-zinc-400 leading-relaxed">
            ...
            <div className="p-4.5 sm:p-6 rounded-2xl bg-zinc-950/80 border border-zinc-800/90 hover:border-purple-500/60 transition-all space-y-3 sm:space-y-4">
              ...
              <h3 className="text-lg sm:text-xl font-bold text-white">High-Converting Architecture</h3>
              <p className="text-xs sm:text-sm text-zinc-400 leading-relaxed">
      ...
      {/* Tech Stack Strip */}
      <section className="py-10 sm:py-16 bg-zinc-950/60 border-t border-zinc-800">
        <div className="container max-w-6xl mx-auto px-4 sm:px-6 text-center space-y-6 sm:space-y-8">
          <p className="text-[10px] sm:text-xs font-mono font-bold tracking-widest uppercase text-zinc-500">
            POWERED BY MODERN PRODUCTION INFRASTRUCTURE
          </p>
          <div className="flex flex-wrap items-center justify-center gap-2.5 sm:gap-4 text-zinc-400 font-mono text-[11px] sm:text-sm">
            <span className="px-3 py-1.5 rounded-full bg-zinc-900 border border-zinc-800 text-white font-bold">React 18</span>
            <span className="px-3 py-1.5 rounded-full bg-zinc-900 border border-zinc-800 text-white font-bold">Next.js 15</span>
            <span className="px-3 py-1.5 rounded-full bg-zinc-900 border border-zinc-800 text-white font-bold">TypeScript</span>
            <span className="px-3 py-1.5 rounded-full bg-zinc-900 border border-zinc-800 text-white font-bold">Tailwind CSS</span>
            <span className="px-3 py-1.5 rounded-full bg-zinc-900 border border-zinc-800 text-white font-bold">Framer Motion</span>
            <span className="px-3 py-1.5 rounded-full bg-zinc-900 border border-zinc-800 text-white font-bold">Vercel Edge</span>
          </div>
