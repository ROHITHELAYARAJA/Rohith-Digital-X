    ...
    <div className="min-h-screen bg-[#070708] text-white selection:bg-purple-600 selection:text-white">
      ...
      <div className="pt-28 pb-4 container max-w-6xl mx-auto px-4 sm:px-6">
        <button
          ...
          className="inline-flex items-center gap-2 text-xs font-mono font-semibold text-zinc-400 hover:text-purple-400 transition-colors cursor-pointer group"
        >
        ...
        <div className="container max-w-6xl mx-auto px-4 sm:px-6 relative z-10">
          <div className="space-y-6 max-w-3xl">
            <div className="flex flex-wrap items-center gap-2">
              <span className="px-3 py-1 rounded-full bg-purple-500/10 border border-purple-500/25 text-[11px] font-mono font-bold text-purple-300">
            ...
            <div className="flex flex-wrap items-center gap-3 pt-2">
              <HeyDigitalButton variant="purple" size="lg" onClick={handleDiscussSimilar}>
        ...
        <div className="container max-w-6xl mx-auto px-4 sm:px-6 space-y-16">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-5 p-6 sm:p-8 rounded-3xl bg-zinc-950/90 text-white border border-zinc-800 shadow-2xl relative overflow-hidden">
              <div className="space-y-4">
                <div className="text-xs font-mono text-purple-400 uppercase font-bold">Client Testimonial</div>
          ...
          <div className="space-y-8 pt-6 border-t border-zinc-800">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="p-6 rounded-2xl bg-zinc-950/80 border border-zinc-800/90 hover:border-purple-500/60 transition-all space-y-3">
